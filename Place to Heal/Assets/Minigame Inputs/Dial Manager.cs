...
//     version 1.14.2
//     from Assets/Minigame Inputs/Dial Manager.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Minigame Inputs/Dial Manager.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @DialManager: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""New action map"",
            ""id"": ""aa6a3033-83ca-4b8e-aef0-3667ec7a4a20"",
            ""actions"": [
                {
                    ""name"": ""Press"",
                    ""type"": ""Button"",
                    ""id"": ""cfdcae60-2849-4923-89b3-c7fb896fec8c"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""87bf30d7-4445-4909-b1a3-776485c0152c"",
                ...
                {
                    ""name"": """",
                    ""id"": ""29d12a5c-1e74-4fbf-bb4e-4bbf04274e5c"",
    ...
    ""controlSchemes"": []
        ...
        m_Newactionmap_Press = m_Newactionmap.FindAction("Press", throwIfNotFound: true);
    }

    ~@DialManager()
    {
        UnityEngine.Debug.Assert(!m_Newactionmap.enabled, "This will cause a leak and performance issues, DialManager.Newactionmap.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Newactionmap_Press;
    /// <summary>
    /// Provides access to input actions defined in input action map "New action map".
    /// </summary>
    public struct NewactionmapActions
    {
        private @DialManager m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public NewactionmapActions(@DialManager wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Newactionmap/Press".
        /// </summary>
        public InputAction @Press => m_Wrapper.m_Newactionmap_Press;
        /// <summary>
